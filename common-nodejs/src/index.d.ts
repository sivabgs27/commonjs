...
// *************** ts ***************************************************************************
    ...
    class Dictionary<K, V> {
        ...
        getEntries(): IDictionaryPair<K, V>[];
    ...
    export function getHostIP(ifaceName?: string): string;
    ...
    export var serviceInfo: ServiceInfo;
    export var isParentProcess: boolean;
    ...
    export class MessageDestination {
        ...
        constructor(type: MessageDestinationType);
    ...
    export interface Invoker {
        ...
        //Need to move to an abstract class with typescript upgrade
    ...
    export class DelayingInvoker implements Invoker {
        ...
        constructor(delayed: Invoker, delay: number, targetSystem?: string);
        invoke(context: InvocationContext, callback: ContextCallback);
        getTargetSystem(): string;
        getServiceCall(): string;
    }
    ...
    export class BaseTemplate {
        ...
        sendResultViaBus: boolean;

        constructor(invoker: Invoker, guardInvoker?: InvokerWrapper);
        disableResultViaBus(): SimpleTemplate;
    ...
    export class PingPongTemplate {
        ...
        startProcess(message: GenericRequest): ProcessInfo;
        continueProcess(message: ProcessResponse);
        getMessageBus(): Bus;
    ...
    export class Transition {
        ...
        constructor(from, event, to, final: boolean);
    }
    ...
    export class HandlerRecord {
        ...
        constructor(handler: Handler, match, type: HandlerType);
    }
    ...
    export class JsonClient {
        headers: any;
        encoding: JsonClientEncoding;
        options: any;

        constructor(client: any, url: Url, options?: any);
    ...
    export function parametriseUrl(url: string, params);

    // ************** Common InvokerSSLSecurityConfig used by Json and Soap Invokers ***************
    ...
    export class JsonAction {
        ...
        constructor(method: HttpMethod, body?: any, path?: string, headers?: any);
    ...
    export class SoapAction {
        ...
        constructor(operation: string, body?: any, extraHttpHeaders ?: any);
    }
    ...
    export class ServiceAction {
        ...
        constructor(service: string, version: string, type: ServiceActionType, request: GenericRequest);
    ...
    export class LdapSearchActionOptions {
        filter: string;
        scope: LdapSearchActionOptionsScope;
        attributes: string[];
        attrsOnly: boolean;
        sizeLimit: number;
        timeLimit: number;
    ...
    export class LdapModifyActionChange {
        operation: LdapModifyActionChangeType;
        data: any;

        constructor(operation: LdapModifyActionChangeType, data: any);
        toClientChange();
    }
    ...
    export class LdapAddAction extends LdapAction {
        ...
        constructor(dn: string, entry: any);
        execute(client: any, context: InvocationContext, callback: ContextCallback);
    }
    ...
    export class LdapSearchAction extends LdapAction {
        options: LdapSearchActionOptions;

        constructor(dn: string, options?: LdapSearchActionOptions);
        execute(client:any, context:InvocationContext, callback:ContextCallback);
    }
    ...
    export class LdapInvoker implements Invoker {
        ...
        constructor(url: string, bindDN: string, bindCredentials: string, targetSystem?: string);
        invoke(context: InvocationContext, callback: ContextCallback);
        getTargetSystem(): string;
        getServiceCall(): string;
    }
    export interface MongoResultHandler {
        (err?: any, res?: any, body?: any): any;
    }
    export class MongoDatabaseClient {
        url: Url;
        constructor(url: Url);
        get(body: any, resultHandler: MongoResultHandler): void;
        post(body: any, resultHandler: MongoResultHandler): void;
        put(body: any, resultHandler: MongoResultHandler): void;
        del(body: any, resultHandler: MongoResultHandler): void;
    }
    export function getMongoDatabaseClient(url: any, path?: string, params?: {}): any;
    export function parametriseUrl(url: string, params: any): string;
    ...
    export class MongoInvoker implements Invoker {
        ...
        invoke(context: InvocationContext, callback: ContextCallback): void;
        setTargetSystem(targetSystem: string): void;
        getTargetSystem(): string;
        getServiceCall(): string;
    }

    // *************** conditional-template.ts ***************************************************************************
    ...
    export class ConditionalChainTemplate extends ConditionalTemplate {
        constructor(namedItems: ItemMap, guardInvoker?: InvokerWrapper);
        prepareFinalOutput(context: InvocationContext): void;
    }
